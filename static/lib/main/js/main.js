...
$(document).ready(function () {
    ...
    $("button#add-dataset").on("click", function(e) {
        var datasetIndex = datasetList.length;
        datasetList.push({
            name: "Dummy Dataset " + datasetIndex,
            element: null
        });

        datasetList[datasetIndex].element = $("<div>")
        datasetList[datasetIndex].element.html(datasetList[datasetIndex].name);
        $("button#add-dataset").before(datasetList[datasetIndex].element);
